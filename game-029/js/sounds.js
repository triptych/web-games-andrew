...
// --- Sound effects ---
// TODO: tune further once combat/loot/shop feel is being iterated on
...
export function playSwordHit() {
    _sweep('square', 320, 90, 0.1, 0.25);
    _noise(0.05, 0.1, 0.02);
}

export function playMonsterDeath() {
    _sweep('sawtooth', 500, 60, 0.4, 0.3);
}

export function playPlayerHurt() {
    _sweep('square', 200, 60, 0.2, 0.3);
}
