...
// --- Hand-authored levels (generated by _genmaze.mjs, then verified) ---
// Each level is a recursive-backtracker maze (real corridors + dead-ends),
// lightly "braided" (a few dead-ends opened into loops so you can circle and
// dodge the horde). The exit ('X') sits in a sealed chamber whose only entrance
// is its key-gated door(s) ('D'); deeper levels add nests, treasure and doors.
// Difficulty (spawn rate / enemy mix) is scaled separately in nests.js.
// To regenerate: `node _genmaze.mjs` (writes _levels.txt) and paste below.
export const LEVELS = [
    // Level 1 - recursive-backtracker maze, lightly braided; 1 door
    [
        '###################',
        '#S..........#.....#',
        '#.###.###.#.#.#.###',
